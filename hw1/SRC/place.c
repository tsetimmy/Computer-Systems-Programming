	 ...
	 int *x_lookup)
{
	...
	{			/* Move was rejected.  */
        ...
        int inet1, inet2, inet3, inet4;

      for(k = 0; k + 4 < num_nets_affected; k+=4) {
        inet1 = nets_to_update[k+0];
        inet2 = nets_to_update[k+1];
        inet3 = nets_to_update[k+2];
        inet4 = nets_to_update[k+3];

        temp_net_cost[inet1] = -1;
        temp_net_cost[inet2] = -1;
        temp_net_cost[inet3] = -1;
        temp_net_cost[inet4] = -1;
      }
